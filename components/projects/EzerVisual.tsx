              ...
              >
                ...
                <div className="absolute bottom-[46px] inset-x-0 z-30 pointer-events-auto flex flex-col items-center justify-center px-3">
                  <motion.div
                    ...
                    className="relative w-[260px] sm:w-[280px] max-w-[88vw] flex flex-col items-center"
                  >
                    <AppBorderBeam
                      size="sm"
                      colorVariant="aurora"
                    ...
                    >
                      <div className="relative w-full rounded-full bg-[#070B12]/95 border border-white/20 px-3.5 py-1.5 sm:py-2 text-white flex items-center justify-center min-h-[38px] overflow-hidden shadow-2xl">
                        {isListeningInitial && (
                          <div className="flex items-center justify-center gap-1.5 text-xs font-mono font-medium text-white/90 select-none">
                                ...
                                return (
                                  <span
                                    ...
                                    className={`inline-block mr-1 transition-all duration-100 ${
                                      isCurrent
                                        ? 'text-[#38BDF8] font-bold scale-[1.06] drop-shadow-[0_0_6px_rgba(56,189,248,0.9)]'
                                        : isSpoken
                        ...
                        {isBorderBeamActive && (
                          <div className="relative z-30 flex items-center justify-center gap-1.5 text-xs font-mono font-semibold text-[#38BDF8]">
                        ...
                        <div className="relative w-full rounded-full bg-[#070B12]/95 border border-white/20 px-3.5 py-1.5 text-white flex items-center justify-center min-h-[36px] shadow-2xl overflow-hidden">
                                ...
                                {FILLET_WORDS.map((word, i) => {
                                  ...
                                  return (
                                    <span
                                      ...
                                      className={`inline-block mr-1 transition-all duration-100 ${
                                        isCurrent
                                          ? 'text-[#38BDF8] font-bold scale-[1.06]'
                                          : isSpoken
                          ...
                          {isIterationDone && !isEndlessClimax && (
                            <motion.div
                              ...
                              animate={{ opacity: 1, scale: 1 }}
                              className="relative z-30 flex items-center justify-center gap-1.5 text-xs font-mono font-semibold text-[#10B981] whitespace-nowrap"
                            >
                                  ...
                                  return (
                                    <span
                                      ...
                                      className={`inline-block mr-1.5 transition-all duration-120 ${
                                        isCurrent
                                          ? 'text-[#00F0FF] font-bold scale-[1.10] drop-shadow-[0_0_8px_rgba(0,240,255,0.9)]'
                                          : isSpoken
